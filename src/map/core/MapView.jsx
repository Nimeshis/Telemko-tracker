...
const MapView = ({ children }) => {
  ...
  const activeMapStyles = useAttributePreference(
    "activeMapStyles",
    "googleHybrid,googleSatellite,googleRoad"
  );
  const [defaultMapStyle] = usePersistedState("selectedMapStyle", "googleRoad"); // Set default to Google Road
  ...
  useEffect(() => {
    ...
    const styles = filteredStyles.length
      ? filteredStyles
      : mapStyles.filter((s) => s.id === "googleRoad");
