...
import Remainder from "./settings/Remainder";
import Jobs from "./settings/Jobs";
import Expense from "./settings/Expense";
import ClasifyTrips from "./settings/ClassifyTrips";
import TravelPage from "./settings/TravelPage";
    ...
    <Routes>
      ...
      <Route path="/" element={<App />}>
        ...
        <Route path="settings">
          ...
          <Route path="announcemnt" element={<AnnouncementPage />} />
          <Route path="expense" element={<Expense />} />
          <Route path="classifyTrips" element={<ClasifyTrips />} />
