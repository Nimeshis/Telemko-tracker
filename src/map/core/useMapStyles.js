...
export default () => {
  ...
  const googleMapKey =
    useAttributePreference("googleMapKey") ||
    "AIzaSyC45ZxGY_PnCnnUiPpwc-52kcsYaULtRUs";
    ...
    () => [
      ...
      },
      {
        ...
        style: styleCustom({
          tiles: [0, 1, 2, 3].map(
            (i) =>
              `https://mt${i}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}&s=Ga&key=${googleMapKey}`
          ),
          maxZoom: 20,
          attribution: "© Google",
        }),
      ...
      },
      {
        ...
        style: styleCustom({
          tiles: [0, 1, 2, 3].map(
            (i) =>
              `https://mt${i}.google.com/vt/lyrs=s&x={x}&y={y}&z={z}&s=Ga&key=${googleMapKey}`
          ),
          maxZoom: 20,
          attribution: "© Google",
        }),
      ...
      },
      {
        ...
        style: styleCustom({
          tiles: [0, 1, 2, 3].map(
            (i) =>
              `https://mt${i}.google.com/vt/lyrs=y&x={x}&y={y}&z={z}&s=Ga&key=${googleMapKey}`
          ),
          maxZoom: 20,
          attribution: "© Google",
        }),
